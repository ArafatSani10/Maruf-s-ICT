                ...
                >
                    {batches.map((batch, index) => (
                        <SwiperSlide key={index}>
                            <div className="group bg-gradient-to-br from-[#0f1e3a] to-[#0a1630] border border-gray-700 rounded-2xl overflow-hidden ">
                                ...
                                <div className="p-6">
                                    ...
                                    {/* CTA Button */}
                                    <button className="w-full bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold py-3 px-4 rounded-xl transition-all duration-300 transform hover:scale-[1.02] group/btn flex items-center justify-center gap-2">
                    ...
                    {/* Custom Navigation */}
                    <div className="swiper-button-prev !text-blue-400 !left-0 after:!text-xl"></div>
                    <div className="swiper-button-next !text-blue-400 !right-0 after:!text-xl"></div>
                </Swiper>
            </div>

            {/* View All Button */}
            {/* <div className="text-center mt-8">
                <button className="inline-flex items-center gap-2 border border-blue-500 text-blue-400 hover:bg-blue-500 hover:text-white px-6 py-3 rounded-xl font-semibold transition-all duration-300">
                    View All Batches
...
export default FeaturedBatchesSlider;